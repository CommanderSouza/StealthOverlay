...
function StealthOverlay_OnEvent(event, arg1, arg2)
	...
	if (event == "COMBAT_TEXT_UPDATE" and arg1 == "AURA_START") and (arg2 == L_STEALTH or arg2 == L_PROWL or arg2 == L_CLOAK) then
	...
	if (event == "COMBAT_TEXT_UPDATE" and arg1 == "AURA_END") and (arg2 == L_STEALTH or arg2 == L_PROWL or arg2 == L_CLOAK) then
	...
	if event == "PLAYER_ENTERING_WORLD" then
		...
		elseif ( class == "DRUID" ) then
			...
			if ( StealthOverlay_HasAura("player", L_CLOAK) ) then
				StealthOverlayFrame.display=true;
				StealthOverlayFrame.onload=true;
				StealthOverlayFrame.timer=STEALTHOVERLAY_SHOWTIME;
				StealthOverlayFrame:SetAlpha(1);
